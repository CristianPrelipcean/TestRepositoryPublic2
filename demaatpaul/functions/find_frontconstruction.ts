find_FrontConstruction(FrontProgram:string, HStrip:string, HPos:string, Width:number, Height:number, PartGroup:string, FrontDesign:string):ICT_tab_FrontConstruction{
