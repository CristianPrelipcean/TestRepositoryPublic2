  ...
  // Insert the Upright
  let FinishPanel = this.addpart_FinishPanel(0, heightOffset - this.mod_UprightOverdimensionBtm, 0, this.mod_UprightThk, this.mod_Height - heightOffset + this.mod_UprightOverdimensionBtm + this.mod_UprightOverdimensionTop , this.mod_Depth);
  ...
  FinishPanel.pa_FinishPanelHeight = this.mod_Height - heightOffset + this.mod_UprightOverdimensionBtm + this.mod_UprightOverdimensionTop;
