  ...
  //  WHEN THE PUSHTOOPEN IS UPDATED (ALL CALCULATION INSIDE mc_Pushtoopen01) THIS CALCULATION SHOULD NOT BE NECESSARY (João Lisboa)
  //===================================================

  let iFrontOverlay = GlobalFunc.calc_FrontOverlay(
    this, retDoorInfo.width,
    retDoorInfo.height,
    retDoorInfo.posX + this.mod_Originpos[0],
    this.mod_FrontPosStart + retDoorInfo.posY, 'FromFront'
  );
