	...
	function AddDoor(m: any, doorHeight: number, doorPosition: number, intNmbr: number, intQty: number) {
		...
		try {
			...
			if (doorInfo.configValid) {
				...
				Door.mod_FrontPosStart = doorPosition;
	...
	if (FridgeInfo.SplitDoor) {
		...
		// Add the doors
		AddDoor(this, frontHgt1, 0, 1, 2);
		AddDoor(this, frontHgt2, frontPos2, 2, 2);
	}
	else {

		// Add the door
		AddDoor(this, frontHgt1, 0, 1, 1);
	}
