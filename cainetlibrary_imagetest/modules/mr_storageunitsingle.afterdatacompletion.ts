	...
	//======================================================================
	// Apply automatic filler logic to return and visibility values
	//======================================================================
	...
	const needsVisibleSideLeft = autoFillerLeft ? false : moduleContextInfo.NeedsVisibleSideLeft;
	const needsVisibleSideRight = autoFillerRight ? false : moduleContextInfo.NeedsVisibleSideRight;
	...
	const createAutoFiller = (direction: "Left" | "Right", width: number, originX: number) => {
		...
		filler.mod_Height = this.mod_Height - this.mod_FrontGapHorTop;
