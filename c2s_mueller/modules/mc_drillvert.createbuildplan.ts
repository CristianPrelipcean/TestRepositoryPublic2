  ...
  try {
    ...
    if (this.mod_DrillinglineLogic == 'Descriptor') {
      ...
      for (let i = 0; i < DrillData.Drills(this); i++) {
        ...
        if (DrillData.PosX(this, i, descriptorPositions[i]) < DrillData.MinPositionX(this) || DrillData.PosX(this, i, descriptorPositions[i]) > DrillData.MaxPositionX(this)) {
        ...
        if (DrillData.PosY(this, i, descriptorPositions[i]) < DrillData.MinPositionY(this) || DrillData.PosY(this, i, descriptorPositions[i]) > DrillData.MaxPositionY(this)) {
        ...
        if (DrillData.PosZ(this, i, descriptorPositions[i]) < DrillData.MinPositionZ(this) || DrillData.PosZ(this, i, descriptorPositions[i]) > DrillData.MaxPositionZ(this)) {
      ...
      // Log the error and stop execution if any function call fails
        ...
        let ErrorMessage = GlobalFunc.find_ErrorList('Error 21007', 1);
