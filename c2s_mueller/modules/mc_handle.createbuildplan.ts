...
for (let i = 0; i < DrillQty; i++){
  ...
  let elemGraphics = this.addpart_ProcessingGraphics(xCoord, yCoord, this.mod_Thickness - HandleDrillDepth - 0.5, this.mod_Diameter,this.mod_Diameter, HandleDrillDepth + 1);
