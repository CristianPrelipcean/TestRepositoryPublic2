...
// Add the left door  
if (this.mod_FrontType == 'DoorLeft') {
  Panel=this.addpart_DoorLeft(0,0,0,this.mod_Width,this.mod_Height,this.mod_Thickness);
}

// Add the right door
else if (this.mod_FrontType == 'DoorRight') {
  Panel=this.addpart_DoorRight(0,0,0,this.mod_Width,this.mod_Height,this.mod_Thickness);
}

// Add the drawer
else if (this.mod_FrontType == 'Drawer') {
  Panel=this.addpart_Drawer(0,0,0,this.mod_Width,this.mod_Height,this.mod_Thickness);
}

// Error if no mod_FrontType found
else{logError('Error 22006: The selected value for the attribute Fronttype is not valid.');}
